# Comparing `tmp/appmesh-1.0.8-py3-none-any.whl.zip` & `tmp/appmesh-1.0.9-py3-none-any.whl.zip`
...
+Zip file size: 16379 bytes, number of entries: 6
+-rw-r--r--  2.0 unx       11 b- defN 24-May-21 12:51 appmesh/__init__.py
+-rw-r--r--  2.0 unx    59572 b- defN 24-May-21 12:51 appmesh/appmesh_client.py
+-rw-r--r--  2.0 unx    10786 b- defN 24-May-21 12:51 appmesh-1.0.9.dist-info/METADATA
+-rw-r--r--  2.0 unx       92 b- defN 24-May-21 12:51 appmesh-1.0.9.dist-info/WHEEL
+-rw-r--r--  2.0 unx        8 b- defN 24-May-21 12:51 appmesh-1.0.9.dist-info/top_level.txt
+-rw-rw-r--  2.0 unx      455 b- defN 24-May-21 12:51 appmesh-1.0.9.dist-info/RECORD
+6 files, 70924 bytes uncompressed, 15557 bytes compressed:  78.1%
```
...
+Filename: appmesh-1.0.9.dist-info/METADATA
 Comment: 
 
-Filename: appmesh-1.0.8.dist-info/WHEEL
+Filename: appmesh-1.0.9.dist-info/WHEEL
 Comment: 
 
-Filename: appmesh-1.0.8.dist-info/top_level.txt
+Filename: appmesh-1.0.9.dist-info/top_level.txt
 Comment: 
 
-Filename: appmesh-1.0.8.dist-info/RECORD
+Filename: appmesh-1.0.9.dist-info/RECORD
 Comment: 
 
 Zip file comment:
```

## Comparing `appmesh-1.0.8.dist-info/METADATA` & `appmesh-1.0.9.dist-info/METADATA`
...
+Metadata-Version: 2.1 Name: appmesh Version: 1.0.9 Summary: Client SDK for App
