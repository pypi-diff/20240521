# Comparing `tmp/play3slib-0.0.2.tar.gz` & `tmp/play3slib-0.0.3.tar.gz`
...
## Comparing `play3slib-0.0.2.tar` & `play3slib-0.0.3.tar`
...
### Comparing `play3slib-0.0.2/PKG-INFO` & `play3slib-0.0.3/PKG-INFO`
...
### Comparing `play3slib-0.0.2/setup.py` & `play3slib-0.0.3/setup.py`
...
### Comparing `play3slib-0.0.2/src/play3slib.egg-info/PKG-INFO` & `play3slib-0.0.3/src/play3slib.egg-info/PKG-INFO`
