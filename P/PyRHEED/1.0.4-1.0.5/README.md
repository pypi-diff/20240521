# Comparing `tmp/pyrheed-1.0.4.tar.gz` & `tmp/pyrheed-1.0.5.tar.gz`
...
### Comparing `pyrheed-1.0.4/src/PyRHEED.egg-info/PKG-INFO` & `pyrheed-1.0.5/src/PyRHEED.egg-info/PKG-INFO`
