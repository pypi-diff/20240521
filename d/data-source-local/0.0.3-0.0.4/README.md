# Comparing `tmp/data_source_local-0.0.3.tar.gz` & `tmp/data_source_local-0.0.4.tar.gz`
...
## Comparing `data_source_local-0.0.3.tar` & `data_source_local-0.0.4.tar`
...
### Comparing `data_source_local-0.0.3/README.md` & `data_source_local-0.0.4/README.md`

 * *Files identical despite different names*

### Comparing `data_source_local-0.0.3/setup.py` & `data_source_local-0.0.4/setup.py`
