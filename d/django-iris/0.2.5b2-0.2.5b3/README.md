# Comparing `tmp/django_iris-0.2.5b2.tar.gz` & `tmp/django_iris-0.2.5b3.tar.gz`
...
### Comparing `django_iris-0.2.5b2/intersystems_iris/_IRISList.py` & `django_iris-0.2.5b3/intersystems_iris/_IRISList.py`
