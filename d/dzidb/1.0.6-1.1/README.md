# Comparing `tmp/dzidb-1.0.6.tar.gz` & `tmp/dzidb-1.1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "dzidb-1.0.6.tar", last modified: Tue May 21 09:04:19 2024, max compression
+gzip compressed data, was "dzidb-1.1.tar", last modified: Tue May 21 07:45:01 2024, max compression
```

## Comparing `dzidb-1.0.6.tar` & `dzidb-1.1.tar`

### file list

```diff
@@ -1,13 +1,13 @@
-drwxrwxrwx   0        0        0        0 2024-05-21 09:04:19.893882 dzidb-1.0.6/
--rw-rw-rw-   0        0        0     1088 2024-05-20 06:49:44.000000 dzidb-1.0.6/LICENSE.txt
--rw-rw-rw-   0        0        0      208 2024-05-21 09:04:19.893882 dzidb-1.0.6/PKG-INFO
--rw-rw-rw-   0        0        0       26 2024-05-20 06:49:44.000000 dzidb-1.0.6/README.rst
-drwxrwxrwx   0        0        0        0 2024-05-21 09:04:19.892044 dzidb-1.0.6/dzidb.egg-info/
--rw-rw-rw-   0        0        0      208 2024-05-21 09:04:19.000000 dzidb-1.0.6/dzidb.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      198 2024-05-21 09:04:19.000000 dzidb-1.0.6/dzidb.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2024-05-21 09:04:19.000000 dzidb-1.0.6/dzidb.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0       38 2024-05-21 09:04:19.000000 dzidb-1.0.6/dzidb.egg-info/entry_points.txt
--rw-rw-rw-   0        0        0        6 2024-05-21 09:04:19.000000 dzidb-1.0.6/dzidb.egg-info/top_level.txt
--rw-rw-rw-   0        0        0     3316 2024-05-21 09:04:09.000000 dzidb-1.0.6/dzidb.py
--rw-rw-rw-   0        0        0       85 2024-05-21 09:04:19.894899 dzidb-1.0.6/setup.cfg
--rw-rw-rw-   0        0        0      348 2024-05-21 09:04:17.000000 dzidb-1.0.6/setup.py
...
### Comparing `dzidb-1.0.6/LICENSE.txt` & `dzidb-1.1/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `dzidb-1.0.6/dzidb.py` & `dzidb-1.1/dzidb.py`
