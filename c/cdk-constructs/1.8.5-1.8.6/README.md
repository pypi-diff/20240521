# Comparing `tmp/cdk-constructs-1.8.5.tar.gz` & `tmp/cdk-constructs-1.8.6.tar.gz`
...
## Comparing `cdk-constructs-1.8.5.tar` & `cdk-constructs-1.8.6.tar`
...
### Comparing `cdk-constructs-1.8.5/LICENSE` & `cdk-constructs-1.8.6/LICENSE`

 * *Files identical despite different names*

### Comparing `cdk-constructs-1.8.5/PKG-INFO` & `cdk-constructs-1.8.6/PKG-INFO`
...
### Comparing `cdk-constructs-1.8.5/README.md` & `cdk-constructs-1.8.6/README.md`

 * *Files identical despite different names*

### Comparing `cdk-constructs-1.8.5/setup.py` & `cdk-constructs-1.8.6/setup.py`
...
### Comparing `cdk-constructs-1.8.5/src/cdk-constructs/__init__.py` & `cdk-constructs-1.8.6/src/cdk-constructs/__init__.py`

 * *Files identical despite different names*

### Comparing `cdk-constructs-1.8.5/src/cdk_constructs.egg-info/PKG-INFO` & `cdk-constructs-1.8.6/src/cdk_constructs.egg-info/PKG-INFO`
