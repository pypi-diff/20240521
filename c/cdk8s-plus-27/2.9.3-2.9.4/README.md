# Comparing `tmp/cdk8s-plus-27-2.9.3.tar.gz` & `tmp/cdk8s-plus-27-2.9.4.tar.gz`
...
## Comparing `cdk8s-plus-27-2.9.3.tar` & `cdk8s-plus-27-2.9.4.tar`
...
### Comparing `cdk8s-plus-27-2.9.3/LICENSE` & `cdk8s-plus-27-2.9.4/LICENSE`

 * *Files identical despite different names*

### Comparing `cdk8s-plus-27-2.9.3/PKG-INFO` & `cdk8s-plus-27-2.9.4/PKG-INFO`
...
### Comparing `cdk8s-plus-27-2.9.3/README.md` & `cdk8s-plus-27-2.9.4/README.md`

 * *Files identical despite different names*

### Comparing `cdk8s-plus-27-2.9.3/setup.py` & `cdk8s-plus-27-2.9.4/setup.py`
...
### Comparing `cdk8s-plus-27-2.9.3/src/cdk8s_plus_27/__init__.py` & `cdk8s-plus-27-2.9.4/src/cdk8s_plus_27/__init__.py`

 * *Files identical despite different names*

### Comparing `cdk8s-plus-27-2.9.3/src/cdk8s_plus_27/k8s/__init__.py` & `cdk8s-plus-27-2.9.4/src/cdk8s_plus_27/k8s/__init__.py`

 * *Files identical despite different names*

### Comparing `cdk8s-plus-27-2.9.3/src/cdk8s_plus_27.egg-info/PKG-INFO` & `cdk8s-plus-27-2.9.4/src/cdk8s_plus_27.egg-info/PKG-INFO`
